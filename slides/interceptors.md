...
public class LoggingInterceptor implements HttpConnectionRequestInterceptor, HttpConnectionResponseInterceptor {
    ...
    public HttpConnectionInterceptorContext interceptResponse(HttpConnectionInterceptorContext context) {
        ...
        String msg = "Request Complete: "+ connection.getURL() + "/" + connection.getResponseCode();
